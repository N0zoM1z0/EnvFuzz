...
def main():
    ...
    root = repo / "findings/20260722-sqlite3-action-v4-runtime-gated-eval"
    ...
    jsonl_path = root / "sqlite3-v4-results.jsonl"
    csv_path = root / "sqlite3-v4-results.csv"
    summary_path = root / "sqlite3-v4-summary.json"
